...
export const Payment = () => {
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.put("http://localhost:4000/bookings/booking/updateStatus/" + id, data)
      console.log(res.data)
  ...
  return (
    <>
      ...
      {isLoading ? <CustomLoader /> :
        ...
        <div className="container-fluid1 py-4 " style={{ marginLeft: `20%` }} >
          <div className="row">
          ...
          <MDBRow className="d-flex justify-content-center py-5" style={{ borderRadius: "15px" }}>
